                        ...
                        float size)
{
    ...
    shape.setPoint(0, project(origin + p1));
    shape.setPoint(1, project(origin + p2));
    shape.setPoint(2, project(origin + p3));
    shape.setPoint(3, project(origin + p4));
}

face::face(sf::Vector3f normal, const sf::Vector3f &origin, float size) {
    // Set the base normal.
    baseNormal = normal;
